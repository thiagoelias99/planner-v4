...
export default function DashboardPage() {
  ...
  const distributionData = [
    {
      key: "Caixa",
      value: Number(dashboard.assetCurrentBalance?.cashBox),
      fill: "var(--color-cash)",
    },
    {
      key: "Renda Fixa",
      value: Number(dashboard.assetCurrentBalance?.fixedIncome),
      fill: "var(--color-fixed)",
    },
    {
      key: "Previdência",
      value: Number(dashboard.assetCurrentBalance?.pension),
      fill: "var(--color-pension)",
    },
    {
      key: "Imóveis",
      value: Number(dashboard.assetCurrentBalance?.property),
      fill: "var(--color-property)",
    },
    {
      key: "Ações M.",
      value: Number(dashboard.assetCurrentBalance?.share),
      fill: "var(--color-share)",
    },
    {
      key: "FIIs",
      value: Number(dashboard.assetCurrentBalance?.reit),
      fill: "var(--color-reit)",
    },
    {
      key: "Internacional",
      value: Number(dashboard.assetCurrentBalance?.international),
      fill: "var(--color-intl)",
    },
    {
      key: "Ouro",
      value: Number(dashboard.assetCurrentBalance?.gold),
      fill: "var(--color-gold)",
    },
    {
      key: "Cripto",
      value: Number(dashboard.assetCurrentBalance?.crypto),
      fill: "var(--color-crypto)",
    },
    {
      key: "Outros",
      value: Number(dashboard.assetCurrentBalance?.other),
  ...
  const strategyData = strategy
    ? [
        {
          key: "Caixa",
          value: Number(strategy.cashBox),
          fill: "var(--color-cash)",
        },
        {
          key: "Renda Fixa",
          value: Number(strategy.fixedIncome),
          fill: "var(--color-fixed)",
        },
        // { key: "Renda Variável", value: Number(strategy.variableIncome), fill: "var(--color-variable)" },
        {
          key: "Previdência",
          value: Number(strategy.pension),
          fill: "var(--color-pension)",
        },
        {
          key: "Imóveis",
          value: Number(strategy.property),
          fill: "var(--color-property)",
        },
        {
          key: "Ações M.",
          value: Number(strategy.share),
          fill: "var(--color-share)",
        },
        {
          key: "FIIs",
          value: Number(strategy.reit),
          fill: "var(--color-reit)",
        },
        {
          key: "Internacional",
          value: Number(strategy.international),
          fill: "var(--color-intl)",
        },
        {
          key: "Ouro",
          value: Number(strategy.gold),
          fill: "var(--color-gold)",
        },
        {
          key: "Cripto",
          value: Number(strategy.crypto),
          fill: "var(--color-crypto)",
        },
        {
          key: "Outros",
          value: Number(strategy.other),
          fill: "var(--color-other)",
        },
      ].filter((item) => item.value > 0)
    : [];
  ...
  return (
    <Container>
      <div className="grid sm:grid-cols-2 lg:grid-cols-6 xl:grid-cols-12 gap-4 py-4 md:gap-6 md:py-6">
        <h1 className="text-3xl font-bold tracking-tight col-span-full">
          Dashboard
        </h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-12 col-span-full">
          <DashboardNumericIndicator
            ...
            decimals={2}
            emphasis
            footer={formatChangeFooter(
              calculateChange(dashboard.totalBalance, "totalBalance"),
            )}
          ...
          <DashboardNumericIndicator
            ...
            footer={formatChangeFooter(
              calculateChange(
                dashboard.variableIncomeTotalBalance,
                "variableIncomeTotalBalance",
              ),
            )}
          ...
          <DashboardNumericIndicator
            ...
            footer={formatChangeFooter(
              calculateChange(
                dashboard.fixedIncomeTotalBalance,
                "fixedIncomeTotalBalance",
              ),
            )}
            className="xl:col-span-2"
          ...
          <DashboardNumericIndicator
            ...
            decimals={2}
            footer={formatChangeFooter(
              calculateChange(dashboard.cashTotalBalance, "cashTotalBalance"),
            )}
            className="xl:col-span-2"
          />
          <DashboardNumericIndicator
            label="Investimentos no Mês"
            amount={dashboard.investmentTotal}
            prefix="R$"
            decimals={2}
            className="xl:col-span-2"
          />
          <DashboardNumericIndicator
            ...
            amount={dashboard.redemptionTotal}
            prefix="R$"
            decimals={2}
            className="xl:col-span-2"
          />
