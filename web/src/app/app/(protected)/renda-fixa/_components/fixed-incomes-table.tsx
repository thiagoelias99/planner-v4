...
export default function FixedIncomesTable({
  ...
  const [selectedFixedIncome, setSelectedFixedIncome] =
    useState<IFixedIncome | null>(null);
    ...
    return [
      ...
      },
      {
        ...
        cell: (row) => {
          ...
          return (
            <p className="text-center font-semibold">{rate.toFixed(2)}%</p>
          );
        },
        size: 100,
      },
        ...
        cell: (row) => {
          ...
          return (
            <div className="flex flex-col items-center">
              <p
                className={`text-center text-sm ${isExpired ? "font-semibold" : ""}`}
              >
