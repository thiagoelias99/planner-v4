...
export default function UpdateOtherAssetsForm({
  asset,
  onSuccess,
  onDeleted,
}: UpdateOtherAssetsFormProps) {
    ...
    <div className="flex flex-col h-full">
      <FormBody onSubmit={form.handleSubmit(onSubmit)} className="flex-1">
        ...
        <Button
          ...
          disabled={updateOtherAsset.isPending}
        >
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button
              variant="destructive"
              className="w-full"
              disabled={deleteOtherAsset.isPending}
            >
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                ativo e removerá seus dados de nossos servidores.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
